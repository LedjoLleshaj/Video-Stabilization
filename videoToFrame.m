    % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
    %   videoToFrame Trasforma un video in frames dentro            %
    %       un intervallo di minuti e secondi specificato.          %
    %                                                               %
    %  INPUT                                                        %
...
while vidObj.CurrentTime < to_time
    ...
    imshow(vidFrame(:,:,:,i)); title(strcat('Time: ', num2str(int8(vidObj.CurrentTime / 60)), ':', num2str(mod(vidObj.CurrentTime,60))));
